...
RSpec.describe AutotaskRuby::ZoneInfo do
    BODY = '<?xml version="1.0" encoding="UTF-8"?><env:Envelope xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:tns="http://autotask.net/ATWS/v1_5/" xmlns:env="http://schemas.xmlsoap.org/soap/envelope/"><env:Body><tns:getZoneInfo><tns:UserName>jared@jaredjenningsdemo.com</tns:UserName></tns:getZoneInfo></env:Body></env:Envelope>'

    let(:valid_url) { 'https://webservices2.autotask.net/ATServices/1.5/atws.asmx' }
    let(:valid_web_url) { 'https://ww2.autotask.net/' }
    let(:subject) { AutotaskRuby::ZoneInfo.new('jared@jaredjenningsdemo.com') }
